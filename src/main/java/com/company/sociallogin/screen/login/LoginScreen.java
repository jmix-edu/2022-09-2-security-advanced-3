...
public class LoginScreen extends Screen {
    ...
    @Subscribe("loginGoogleButton")
    public void onLoginGoogle(Button.ClickEvent event) {
        webBrowserTools.showWebPage("/oauth2/authorization/google", ParamsMap.of("target", "_self"));
    }

    @Subscribe("loginGitHubButton")
    public void onLoginGitHub(Button.ClickEvent event) {
